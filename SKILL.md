...
description: >
  ...
  根据你的问题自动路由到对应子技能。当前包含人岗匹配评估、面试辅导（简历深挖+模拟面试）、商业洞察（从招股书学商业逻辑）、论文选题（从上市公司案例选题），更多子技能持续更新。
  触发方式：@gxg、@观星哥、「分析匹配度」「模拟面试」「分析下招股书」「帮我选论文题目」
  Triggers: @gxg, @guanxing, job fit, interview prep, business analysis, prospectus, thesis topic, career coaching.
  Use this skill when user asks for 匹配度分析、面试辅导、财务面试、商业分析、招股书解读、商业模式学习、论文选题、
...
| 帮我选论文题目、论文选题、从上市公司找论文题目、这个题目能不能写 | `gxg-thesis-topic` | 论文选题导师——结合学校、专业、培养类型与就业方向，从上市公司案例生成可写、可答辩的论文题目 |
...
- 用户的需求不在路由表范围内 → 直接说：「这个超出 GXG 目前的能力范围。我现在能帮你的是：人岗匹配评估、面试辅导（简历深挖+模拟面试）、商业洞察（从招股书学商业逻辑）、论文选题（从上市公司案例选题）。更多技能正在路上——微信 guanxingge2025 告诉星哥你想要什么功能。」
...
*GXG v1.3.0 | 观星哥的财经职场工具箱 | 观星哥 | 微信：guanxingge2025*
